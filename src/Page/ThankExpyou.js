          ...
          <div>
            ...
            <div className="container">
              <div className="jumbotron text-xs-center white-text p-t100">
                ...
                <p className="lead pText">Your Order Payment Status is <strong>Pendinng</strong>.</p>
                <p className="lead pText">Total Payment : <strong>{settingPriceType}&nbsp;{amount}</strong>.</p>
                <p className="lead pText">Your Order is confirm with Order No: "<strong>{orderNo}</strong>" {(titleName!='')?('For'):''} <b>{titleName}</b> </p>
                <p className="pText">Please check your email for more details.</p>
                <hr className="hr-light pText" />
                <p>
                  Having trouble? <Link to="/contactus">Contact us</Link>
                </p>
                <a href="/" className="pText btn btn-red btn-lg btn-red-border1">CONTINUE SHOPPING</a>
              </div>
            </div>
          </div>
          <Footer/>
