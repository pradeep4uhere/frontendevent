    ...
    return (
        ...
        <div className="container containerBox" >
          ...
          <div className="row">
            ...
            {
            (this.state.destinationDetails.shopping)?(
            <div className="col-xl-3 col-md-2 col-sm-4 col-4 pText"><img src="../rudra/images/ico_shopping.png" alt="" className="img-fluid" /><p /><h5>Shopping</h5><p /><p id="cuisin"><div dangerouslySetInnerHTML={{ __html: this.state.destinationDetails.shopping }}/></p></div>
            ):('')}
            {
            (this.state.destinationDetails.cuisine)?(
            ...
            {
            (this.state.destinationDetails.more_information!='')?(
            <div className="col-xl-3 col-md-2 col-sm-4 col-4 pText"><p /><h5>More Info</h5><p /><p id="cuisin"><div dangerouslySetInnerHTML={{ __html: this.state.destinationDetails.more_information }}/><br /></p></div>
            ):('')}
