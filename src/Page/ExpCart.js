...
class ExpCart extends React.Component {
  constructor() {
        super();
        this.state={
          optionValue: [],
  ...
  render() {
    ...
    if(this.state.cartList.cart){
       cartItemArray = this.state.cartList.cart.map((val,i) =>   
            ...
            <th scope="row">
              <div className="p-2">
                <img src={val.attributes.itinerary_image} alt="" width={70} className="img-fluid rounded shadow-sm" />
                <div className="ml-3 d-inline-block align-middle">
                  <h5 className="mb-0"> <a href={"/destinationexpdetails/"+val.attributes.itinerary_id} className="text-dark d-inline-block">{val.name}</a></h5>
                  
                </div>
              </div>
            </th>
            <td className="align-middle">{val.attributes.itinerary_departure_date}</td>
            ...
            {/* <Select
              ...
              /> */}
               ...
               <input type="button" defaultValue="-" className="minus" onClick={((e) => this.handleChange(e,val.attributes.itinerary_id+'-'+val.attributes.itinerary_departures_id,i))} />
               <input type="number" step={1} min={1} max value={optionValue[i]} id={val.attributes.itinerary_id+'-'+val.attributes.itinerary_departures_id} title="Qty" className="input-text qty text" size={4} pattern inputMode  onClick={((e) => this.handleChange(e,val.attributes.itinerary_id+'-'+val.attributes.itinerary_departures_id,i))}/>
               <input type="button" defaultValue="+" className="plus" onClick={((e) => this.handleChange(e,val.attributes.itinerary_id+'-'+val.attributes.itinerary_departures_id,i))}/>
               </div>
              </td>
            <td className="align-middle"><a href="#" className="text-dark" onClick={((e) => this.handleRemove(e,val.attributes.itinerary_id+'-'+val.attributes.itinerary_departures_id))}><i className="fa fa-trash" /></a>
            </td>
          </tr>
      );
    }
              ...
              <table className="table">
                <thead>
                  <tr>
                    ...
                    <th scope="col" className="border-0 bg-light">
                      <div className="py-2 text-uppercase">Departure Date</div>
                    </th>
                    <th scope="col" className="border-0 bg-light">
        ...
        <div className="row py-5 p-4 bg-white rounded shadow-sm">
          ...
          <div className="col-lg-6">
            ...
            <div className="p-4">
              ...
              </ul><a href={"expcheckout?chk="+this.state.cartList.oid} className="btn btn-dark py-2 btn-block">Proceed to checkout</a>
            </div>
          </div>
        </div>
      </div>
