  ...
  render() {
    ...
    return (
        ...
        <div className="element tkt-margin">
            <img className="float-right icon-position featureImg" src={this.props.eventDetails.image} alt="image" height="150" width="270" />
            ...
            <div className="col-xl-3 col-lg-3">
                <img className="float-right icon-position featureIcon" src="../rudra/images/ico_next.png" alt="" />
            </div>
            </div>
        </div> 
        </a>
